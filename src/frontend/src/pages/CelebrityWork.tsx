  ...
  useFrame((state) => {
    if (ref.current) {
      ...
      ref.current.rotation.x =
        Math.sin(state.clock.elapsedTime * 0.35 * speed) * 0.15;
      ref.current.rotation.z = state.clock.elapsedTime * 0.1 * speed;
    }
  });
  return (
    <Float speed={1.5 * speed} floatIntensity={1.8}>
...
const CELEBRITIES: CelebrityWorkType[] = [
  {
    id: "celeb1",
    name: "Bollywood Film Set",
    title: "Lead Actress Transformation",
    description:
      "Crafted a complete cinematic makeup look for a lead actress for a major Bollywood production. The look was praised by the film's director for its authenticity and camera-readiness.",
  ...
  },
  {
    ...
    description:
      "Dressed a popular TV personality for a national awards ceremony in Mumbai. The look — featuring dramatic eyes and flawless skin — was featured in multiple national fashion magazines.",
  ...
  },
  {
    ...
    description:
      "Partnered with a top-tier beauty influencer (5M+ followers) for a luxury brand campaign shoot. The makeup was specifically designed to shine under studio lighting and 4K cameras.",
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <p className="section-eyebrow mb-4">✦ Celebrity Work</p>
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 p-10 md:p-16 items-center">
            <div>
              <p className="section-eyebrow mb-4">Behind the Glamour</p>
              <h3 className="font-display text-4xl md:text-5xl font-light text-foreground mb-5 tracking-wide">
                Where <em className="gradient-gold-text">art meets</em>
                <br /> celebrity
              </h3>
              <p className="text-foreground/60 font-body leading-relaxed mb-7">
                ...
                television channels, and luxury brands.
              </p>
              <div className="flex flex-wrap gap-6">
                {[
                  ...
                  <div key={s.label} className="text-center">
                    <p className="font-display text-3xl font-light gradient-gold-text animate-depth-pulse">
                      {s.num}
                    </p>
                    <p className="text-xs text-foreground/40 tracking-widest uppercase font-body">
                      {s.label}
                    </p>
                  </div>
                ))}
          ...
          {CELEBRITIES.map((work, i) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="w-10 h-10 rounded-full gradient-gold flex items-center justify-center text-white font-display font-bold text-sm flex-shrink-0">
                  {work.name.charAt(0)}
                </div>
                <div>
                  <p className="text-gold text-xs tracking-widest uppercase font-body font-semibold">
                    {work.name}
                  </p>
                  <h4 className="font-display text-xl text-foreground font-semibold mt-0.5 tracking-wide">
                    {work.title}
                  </h4>
                </div>
              </div>
