      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            >
              <h3 className="font-display text-2xl font-semibold gradient-gold-text mb-1 tracking-wide">
                Makeup by Snehal Pawar
              </h3>
              <p className="section-eyebrow mb-5">
                Beauty & Bridal Salon · Amravati
              </p>
              <p className="text-sm text-foreground/55 leading-relaxed font-body max-w-xs">
                Transforming brides into timeless beauties with artistry,
                passion, and precision. Every look — a masterpiece crafted with
                love in Amravati.
              </p>
            </motion.div>
          </div>
          ...
          <div>
            ...
            >
              ...
              <address className="not-italic space-y-3 text-sm text-foreground/55 font-body leading-relaxed">
                <p>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-foreground/40 font-body">
          <p>
